...
export default function EditLockBanner({ missionId, lockState, canEdit }: Props) {
      ...
      <div className="glass-panel bg-command-600/10 border border-command-600/40 rounded-xl px-5 py-3 mb-5 animate-fade-in">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1 text-xs font-medium text-[var(--color-text-primary)] hover:text-[var(--color-text-primary)] bg-[var(--color-bg-elevated)]/50 hover:bg-[var(--color-bg-elevated)]/50 border border-[var(--color-border-primary)] rounded-lg transition-all duration-200"
          >
            Release Lock
          </button>
        </div>
  ...
  if (canEdit && !lockState.locked) {
    return (
      <div className="glass-panel bg-[var(--color-bg-tertiary)]/50 border border-[var(--color-border-primary)] rounded-xl px-5 py-3 mb-5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-[var(--color-text-primary)] bg-command-500 hover:bg-command-400 rounded-lg transition-all duration-200 shadow-lg shadow-glow-blue"
          >
            Start Editing
          </button>
        </div>
